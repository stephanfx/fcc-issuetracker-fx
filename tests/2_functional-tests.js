    ...
    suite('POST /api/issues/{project} => object with issue data', function() {
      ...
      test('Every field filled in', function(done) {
       chai.request(server)
        ...
        .end(function(err, res){
          ...
          assert.notEqual(res.body.update_on, '');
      ...
      test('Required fields filled in', function(done) {
        ...
        .end(function(err, res){          
          ...
          assert.equal(res.body.assigned_to, '', 'Assigned to not blank');
          assert.equal(res.body.status_text, '', 'Status text not blank');
          assert.equal(res.body.open, true);
          assert.notEqual(res.body.created_on, '');
          assert.notEqual(res.body.update_on, '');
          assert.notEqual(res.body._id, '');
      ...
      test('Missing required fields', function(done) {
        ...
        .end(function(err, res){
          ...
          assert.equal(res.body, 'Not all required fields supplied');          
          done();
        });
      });
